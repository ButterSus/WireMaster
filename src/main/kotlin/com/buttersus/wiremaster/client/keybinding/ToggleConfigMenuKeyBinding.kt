...
import com.buttersus.wiremaster.config.WireMasterConfigPermissions
...
class ToggleConfigMenuKeyBinding : AmecsKeyBinding(
    ...
    override fun onPressedPriority(): Boolean {
        if (!WireMasterConfigPermissions.canToggleConfigMenu()) return false
        WireMasterConfig.toggleConfigMenu()
        return true
    }
}
